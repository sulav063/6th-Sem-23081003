...
# Stripe test keys
stripe.api_key = "sk_test_51SSegf4p65rtBqPuYbcc0vsT2BFkTtPYhfKxfMMXeZvnLpjEbuDwB2Xzy4BAUOUG7VpJha7uqn4x3AbeAiSsw5p300IL31bD49"
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="box cart">
                ...
                <button id="checkout-button" class="btn" style="display:none;">Pay with Stripe</button>
            </div>
        </div>

        <script>
            const stripe = Stripe("pk_test_51SSegf4p65rtBqPudScKO7nTlkl5wbD4BCNpRRZBXH25iATvX7dsNHh73nWRPI6Ekocg4CZneeFUK9mVb9jIc5Gv00A5hpkYaa");
            let cart = [];
            ...
            document.getElementById("checkout-button").addEventListener("click", async () => {
                const totalQuantity = cart[0].quantity;
